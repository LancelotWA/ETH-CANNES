...
export function DecryptedText({
  text,
  speed = 50,
  maxIterations = 80, // Default to ~4s if sequential is false
  sequential = false,
  ...
  const [isDecrypted, setIsDecrypted] = useState(animateOn !== 'click' && animateOn !== 'hover' && animateOn !== 'view');
  ...
  useEffect(() => {
    if (animateOn === 'hover') {
      // By default to be scrambled until hovered, instantly encrypt
      encryptInstantly();
